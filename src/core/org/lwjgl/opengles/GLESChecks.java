...
import static org.lwjgl.opengles.GL15.*;
import static org.lwjgl.opengles.GL21.*;
import static org.lwjgl.opengles.GL30.*;
import static org.lwjgl.opengles.GL40.*;
import static org.lwjgl.opengles.GL43.*;
	...
	static int typeToBytes(int type) {
		switch ( type ) {
			...
			case GL_DOUBLE:
				return 8;
			default:
				throw new IllegalArgumentException(String.format("Unsupported OpenGL ES type: 0x%X", type));
		}
	}
